...
docker save "$frontendImage" | bzip2 | pv | ssh {{serverUsername}}@141.136.44.124 "bunzip2 | docker load"
...
docker save "$backendImage" | bzip2 | pv | ssh {{serverUsername}}@141.136.44.124 "bunzip2 | docker load"
