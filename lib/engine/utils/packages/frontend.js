...
const withLogin = {
    'dependencies': Object.assign(Object.assign({}, withRouter.dependencies), { 'axios': '^0.19.0', 'final-form': '^4.18.6', 'react-final-form': '^6.3.3', 'react-redux': '^7.2.0', 'redux': '^4.0.5', 'resize-observer-polyfill': '^1.5.1', 'throttle-debounce': '^2.1.0', 'validator': '^11.1.0' }),
    'devDependencies': Object.assign(Object.assign({}, withRouter.devDependencies), { '@types/jsonwebtoken': '^8.3.5', '@types/validator': '^10.11.3', '@types/react-redux': '^7.1.7', '@types/throttle-debounce': '^2.1.0' }),
};
const withGit = {
    'scripts': {
...
exports.getFrontendPackage = (options) => {
    let packageObject = Object.assign({}, common);
    if (options.withRouter) {
        packageObject = Object.assign(Object.assign({}, packageObject), { dependencies: Object.assign(Object.assign({}, packageObject.dependencies), withRouter.dependencies), devDependencies: Object.assign(Object.assign({}, packageObject.devDependencies), withRouter.devDependencies) });
    }
    ...
    if (options.designLibrary === 'antd') {
        packageObject = Object.assign(Object.assign({}, packageObject), { dependencies: Object.assign(Object.assign({}, packageObject.dependencies), withAntd.dependencies), devDependencies: Object.assign(Object.assign({}, packageObject.devDependencies), withAntd.devDependencies) });
    }
    if (options.withDocker && !options.withBackend) {
        packageObject = Object.assign(Object.assign({}, packageObject), { scripts: Object.assign(Object.assign({}, packageObject.scripts), withDocker.scripts) });
    }
    const withVars = replaceVariables_1.replaceVariables(sort_package_json_1.default(JSON.stringify(packageObject, null, 2)), options);
    return `${withVars}\n`;
};
